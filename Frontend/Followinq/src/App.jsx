function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex flex-col items-center justify-center relative px-4">
      ...
      <h1 className="text-5xl md:text-7xl text-white font-bold mb-2 z-10">Followinq</h1>
      <h2 className="text-2xl md:text-4xl text-white font-bold mb-8 z-10">Coming Soon</h2>
